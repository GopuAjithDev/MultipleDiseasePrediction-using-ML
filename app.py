...
#         # Predicting result
#         prediction = model.predict(np.reshape(p_img, [1, 224, 224, 3]))
...
#         st.text(f"Probability of Pneumonia is {round(pneumonia_prob * 100, 2)}%")
...
if (selected == 'Malaria Detector'):
    ...
    if uploaded_file is not None:
        ...
        malaria_model = load_model('model_vgg19.h5')
